                                   ...
                                   if (mysqli_num_rows($qurey_run)> 0) {
                                        ...
                                        <form action="backend_code.php" method="POST">
                                             ...
                                             <div class="md-3 mt-4">
                                                  ...
                                                  <input type="text" required value="<?= $student['student_name']; ?>" name="add_student_name" placeholder="Enter your full name" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Registration Number:</label>
                                                  <input type="text" required value="<?= $student['registration_number']; ?>" name="add_student_email" placeholder="Start with Capital EN e.g. EN20168758" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Phone:</label>
                                                  <input type="number" required value="<?= $student['phone']; ?>" name="add_student_phone" placeholder="Enter your 10 digit phone number" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Location:</label>
                                                  <input type="text" value="<?= $student['location']; ?>" name="add_student_location" 
                                                  placeholder="Enter your city location"  class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Stop:</label>
                                                  <input type="text" value="<?= $student['stop']; ?>" name="add_student_stop" placeholder="Enter your bus stop" class="form-control">
                                             </div>
